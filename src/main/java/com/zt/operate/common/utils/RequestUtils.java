...
import static com.zt.operate.common.Constants.POST;
import static com.zt.operate.common.Constants.UTF8;
...
public class RequestUtils {
	...
	public static String getLocation(HttpServletRequest request) {
		...
		String[] expectUrl = new String[]{"type=mobile"};
		if (queryString != null && !StringUtils.isIn(queryString,expectUrl)) {
	...
	public static String getStringParameter(HttpServletRequest request,String param){
		String val = request.getParameter(param);
		if(StringUtils.isNotBlank(val) && !"undefined".equals(val)){
	...
	public static String toExceptionPage(String msg ,ModelMap model){
